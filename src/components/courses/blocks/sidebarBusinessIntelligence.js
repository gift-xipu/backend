...
export default function Sidebar({ activeIndex = 1 }) {
  ...
  var urls = [
    { name: "pandasPage", url: "/courses/pages/page2", id: 1 },
    { name: "principlesOfDataPage", url: "/courses/pages/principlesOfData", id: 2 },
    { name: "pythonBasicsPage", url: "/courses/pythonBasics", id: 3 },
    { name: "sqlBasicsPage", url: "/courses/pages/sqlBasics", id: 4 },
